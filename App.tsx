...
export default function App() {
  ...
  useEffect(() => {
    ...
    // The magical delay: 5s of branding, then smooth transition to login
    ...
    return (
      <div className="min-h-screen bg-emerald-500 flex flex-col items-center justify-center text-white p-6 relative overflow-hidden">
        ...
        <div className="z-10 flex flex-col items-center">
            <div className="bg-white p-4 rounded-3xl shadow-xl mb-6 transform rotate-3 animate-fade-in">
                <RefreshCw size={56} className="text-emerald-500" />
            </div>
            <h1 className="text-5xl font-black tracking-tighter mb-2 animate-slide-up">TROCO<span className="text-yellow-300">HOJE</span></h1>
            <p className="text-xl font-medium text-emerald-100 text-center mb-8 max-w-[200px] leading-tight animate-slide-up" style={{animationDelay: '0.1s'}}>O marketplace que te dá lucro todo dia.</p>
